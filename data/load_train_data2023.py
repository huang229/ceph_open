...
index_class = {11: 1, 5:2, 6:3, 16:4, 21:5, 3:6, 7:7, 4:8, 14:9, 15:10, 18:11, 22:12,26:13, 25:14, 29:15, 28:16, 8:17, 2:18, 12:19}
...
class TrainData():
    ...
    def __getitem__(self, item):
        ...
        #     scalev = np.random.randint(7, 10, 1)[0]
...
def data_crop(img, label_coords):
    ...
    x2, y2 = np.random.randint(maxxy[0]+offv, width, 1)[0], np.random.randint(maxxy[1]+offv, height,1)[0]
